...
public class InputFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("The sleeping Barbers Project");
    ...
    private void EnterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterBtnActionPerformed
        try{
        this.BR = Integer.parseInt((String) TAs.getSelectedItem());
        this.customers = Integer.parseInt(Students.getText());
        this.chairs = Integer.parseInt((String) Chairs.getSelectedItem());

        SleepingBR sBR = new SleepingBR(customers, chairs, BR);
        Session s = new Session(BR, customers, chairs);
        s.setSize(970, 542);
        s.setVisible(true);
